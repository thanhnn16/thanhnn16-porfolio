export default {
  ...
  about: {
    ...
    greeting: "Xin chào, tôi là Nông Nguyễn Thành",
  ...
  projects: {
    ...
    items: {
      allureSpa: {
        title: "Allure Spa",
        description: "Hệ thống quản lý spa hiện đại với tính năng đặt lịch và quản lý dịch vụ."
      },
      marineTrace: {
        title: "Marine Trace",
        description: "Hệ thống truy xuất nguồn gốc hải sản tích hợp mã QR."
      },
      allureSpaAdmin: {
  ...
  skills: {
    ...
    kotlinDescription: "Phát triển Android native với Kotlin",
    ...
    databaseAndVersionControl: "Cơ sở dữ liệu & Kiểm soát phiên bản",
    mysqlDescription: "Thiết kế và tối ưu cơ sở dữ liệu với MySQL",
    gitDescription: "Kiểm soát phiên bản và cộng tác với Git",
    native: "Bản ngữ",
    readWrite: "Đọc & Viết",
    n3Level: "Trình độ N3",
    ...
    uiuxDescription: "Tạo ra trải nghiệm thiết kế lấy người dùng làm trung tâm",
